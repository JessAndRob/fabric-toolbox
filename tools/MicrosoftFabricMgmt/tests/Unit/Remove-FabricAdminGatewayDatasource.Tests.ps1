...
<# Behavior tests for Remove-FabricAdminGatewayDatasource. #>
...
Describe 'Remove-FabricAdminGatewayDatasource' -Tag 'UnitTests' {
    It 'DELETEs the datasource endpoint' {
        Remove-FabricAdminGatewayDatasource -GatewayId 'gw-1' -DatasourceId 'ds-1' -Confirm:$false
    ...
    It 'does not call the API under -WhatIf' {
        ...
        Remove-FabricAdminGatewayDatasource -GatewayId 'gw-1' -DatasourceId 'ds-2' -WhatIf
