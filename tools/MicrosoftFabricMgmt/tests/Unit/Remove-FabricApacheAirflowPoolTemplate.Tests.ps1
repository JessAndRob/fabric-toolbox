...
<# Behavior tests for Remove-FabricApacheAirflowPoolTemplate. #>
...
Describe 'Remove-FabricApacheAirflowPoolTemplate' -Tag 'UnitTests' {
    It 'DELETEs the poolTemplates/{id} endpoint' {
        Remove-FabricApacheAirflowPoolTemplate -WorkspaceId 'ws-1' -PoolTemplateId 'pt-1' -Confirm:$false
