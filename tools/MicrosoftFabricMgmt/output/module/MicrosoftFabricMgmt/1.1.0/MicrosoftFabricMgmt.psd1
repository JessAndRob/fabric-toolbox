...
- **Display formatting backfill (pass 2)**: `WarehouseSnapshot` (a full item) folded into the
  ...
  `WarehouseRestorePointView`. Single-object/status/scalar types (networking policies'
